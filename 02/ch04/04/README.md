...
### ex03
```bash
$ aws cloudformation create-stack --stack-name myserver --template-body https://raw.githubusercontent.com/kminsu728/aws-practices/main/02/ch04/04/ex03.json --parameters ParameterKey=KeyName,ParameterValue=mykey_inznet ParameterKey=VPC,ParameterValue=vpc-48b12e23 ParameterKey=InstanceType,ParameterValue=t2.micro
